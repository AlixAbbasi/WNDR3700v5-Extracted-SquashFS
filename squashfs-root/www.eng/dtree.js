...
function dTree(objName,selectedNode) {
	...
	this.icon = {
		root				: 'dtreebase.gif',
		folder			: 'dtreefolder.gif',
		folderOpen	: 'dtreefolderopen.gif',
		node				: 'dtreepage.gif',
		empty				: 'dtreeempty.gif',
		line				: 'dtreeline.gif',
		join				: 'dtreejoin.gif',
		joinBottom	: 'dtreejoinbottom.gif',
		plus				: 'dtreeplus.gif',
		plusBottom	: 'dtreeplusbottom.gif',
		minus				: 'dtreeminus.gif',
		minusBottom	: 'dtreeminusbottom.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
...
//.o
	...
	var str = eval('node' + id);
	echo_info = str.split('*');
	form.nodenumber.value=id;
	form.currentpath.value=echo_info[3];
	var value=""+echo_info[0]+"*"+echo_info[1]+"*"+cn.io+"*"+echo_info[3]+"*"+echo_info[4];
	form.nodevalue.value=value;

    form.todo.value="browse_folder";
		form.submit();	
	}
