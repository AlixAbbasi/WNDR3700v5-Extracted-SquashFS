function static_ip_input_initPage()
{
	//head text
...
function checkStaticIP()
{
	...
	var cf = forms[0];
	var IP_addr = document.getElementById("inputIPaddr");
	var sub_mask = document.getElementById("inputSubMask");
	var gateway = document.getElementById("inputGateway");
	var pre_dns = document.getElementById("inputPreDns");
	var sec_dns = document.getElementById("inputSecDns");
	...
	if(check_static_dns(true)==false)
		return false;
	document.getElementById("c4_ip").value = IP_addr.value;
	document.getElementById("c4_mask").value = sub_mask.value;
	document.getElementById("c4_gateway").value = gateway.value;
	document.getElementById("c4_daddr").value = pre_dns.value;
	document.getElementById("c4_paddr").value = sec_dns.value;
...
addLoadEvent(static_ip_input_initPage);
