...
function check_remote()
{
	...
	warningMessage="Warning , "+"You cannot set the remote IP to be the same as the WAN IP or to include the WAN IP.";
	if(cf.rm_access[0].checked) 
	{
		...
		{
			alert("IP address cannot be on LAN subnet");
			return false;
		}
	...
	{
		alert("Invalid port number. It should be in the range 1024-65534. ");
	...
	for(i=1;i<=forward_array_num;i++)
	{
		...
		{
			alert("The specified port(s) are being used by other configurations. Please check your configurations of Remote Management, Port forwarding, Port Triggering, UPnP Port Mapping table, RIP, and Internet connection type");
			return false;
		}
	}	
	//port_triggering	
