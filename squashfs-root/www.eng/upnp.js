...
function checkupnp()
{
	...
	if(document.forms[0].UPnP.checked == true)
	{
		...
		{
			alert("Invalid Advertisement Period value. The value must be in the range 1-1440.");
			return false;
		}
		...
		{
			alert("Invalid Advertisement Time to Live value. The value must be in the range 1-255.");
			return false;
		}
