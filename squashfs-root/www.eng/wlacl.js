...
var device_name_dup="Duplicate device name.";
var mac_dup="Duplicate MAC address.";

function check_wlacl_add(cf,flag)
{
	if (array_num == 64)
	{
		alert("Max number of rules reached!");
		return false;
	}
	if(cf.device.value=="")
	{
...
function check_wlacl_editnum(cf)
{
	...
	else
	{
		...
		location.href="WLG_acl_edit.htm";
		return false;
	}
}
