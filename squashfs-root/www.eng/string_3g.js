...
function getSystemData(){
	if(!debug) lan_file = 'setup.cgi?next_file=common/system_3g.xml';
	else lan_file = '/common/system_3g.xml';
...
function loadLangugaeFiles(in_lan){
	...
	var msg_file = '/langs/'+in_lan+'/'+'msg.xml';
	var temp = readFile(msg_file);
	var msgDoc = temp.responseXML.documentElement;
	var msgnodes;
	...
	var tag_file = '/langs/'+in_lan+'/'+'ui.xml';
	temp = readFile(tag_file);
